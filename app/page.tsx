...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-5xl bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        {/* Project Overview */}
