      ...
      <div className="text-center py-8 sm:py-12 relative px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-3">
          <Image
            ...
            width={45}
            height={45}
            className="rounded-xl sm:w-[50px] sm:h-[50px]"
          />
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 bg-clip-text text-transparent font-parkinsans">
