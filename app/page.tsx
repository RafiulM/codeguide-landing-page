  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="relative">
        ...
        <HeroSection
          headline="Codeguide Starter Fullstack"
          subHeadline="A modern full-stack TypeScript starter with authentication, database, and UI components"
          customActions={<HeroAuthButtons />}
        />
      </div>
